...
\todo{Explain the components of the design and how they support these tasks.}

These tasks can assist language designers during different
phases of development.
For example, exploratory data analysis can weed out designs that
are incompatible with existing programs.
\todo{Give specific motivation, i.e. gradual typing.}
...
In table~\ref{tab:tasks}, we use Munzner's mid-level and low-level
abstract task taxonomy. \todo{Cite Munzner}
...
\subsection{Package and Function Filtering}
