...
INSERT INTO stats
SELECT 'distinct_record' AS name,
       COUNT(*) AS count
FROM aggregated_types;
...
INSERT INTO stats
SELECT "distinct_package_being_analyzed" AS name,
       COUNT(DISTINCT package_being_analyzed) AS count
FROM aggregated_types;

INSERT INTO stats
SELECT "distinct_package" AS name,
       COUNT(DISTINCT package) AS count
FROM aggregated_types;

INSERT INTO stats
SELECT "distinct_fun_name" AS name,
       COUNT(DISTINCT fun_name) AS count
FROM aggregated_types;

INSERT INTO stats
SELECT "distinct_ret_type" AS name,
       COUNT(DISTINCT arg_t_r) AS count
FROM aggregated_types;

-- analyzed packages table
...
SELECT package, fun_name, SUM(count) AS count
FROM aggregated_types
GROUP BY package, fun_name
ORDER BY count DESC;
