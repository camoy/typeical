<template>
  <div id="about-div" class="pa-10">
    <h2>Motivation</h2>
    <p>
      TypeVis is an interactive visualization of type information about function
      calls for exploration and analysis. It provides facilities for filtering
      data, displaying type signatures as flows, and integrates additional
